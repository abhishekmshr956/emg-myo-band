...
while carryOn:
    ...
    if ball.rect.y > c.WIN_Y - c.BALL_SIZE:
        ...
        lives -= 1
        if lives == 0:
            # Display Game Over Message for 3 secons
    ...
    screen.fill(c.DARKBLUE) # Clear the screen to dark blue
    pygame.draw.line(screen, c.WHITE, [0, 38], [c.WIN_X, 38], 2)

    # Display the scre and the number of lives at the top of the screen
